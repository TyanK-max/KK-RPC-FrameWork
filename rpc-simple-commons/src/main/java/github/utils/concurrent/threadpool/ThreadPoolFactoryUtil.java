package github.utils.concurrent.threadpool;
...
/**
 * @author TyanK
 * @description: Create ThreadPool to complete Netty Reactor model
 * @date 2022/8/6 17:15
 */
...
public class ThreadPoolFactoryUtil {
    public static final Map<String, ExecutorService> THREAD_POOLS = new ConcurrentHashMap<>();
